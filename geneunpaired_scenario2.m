...
writetable(DataTable, strcat('GeneUnpairedDFR/GeneUnpairedDFR_Run', num2str(run),'.xlsx'),'WriteVariableNames', true);
...
xlabel('Time')
ylabel('#mRNA')
saveas(gcf,strcat(['GeneUnpairedDFR/GeneUnpairedDFR_Run', num2str(run)]),'jpg');
close(gcf);

figure
histogram(mh1v)
saveas(gcf,strcat('GeneUnpairedDFR/GeneUnpairedDFR_Histogram', num2str(run)),'jpg');
close(gcf)
...
writetable(Stats, strcat('GeneUnpairedDFR/GeneUnpairedDFR_PearsonSpearman.xlsx'),'WriteVariableNames', true);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
