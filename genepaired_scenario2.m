...
writetable(DataTable, strcat('GenePairedDFR/GenePairedDFR_Run', num2str(run),'.xlsx'),'WriteVariableNames', true);
...
xlabel('Time')
ylabel('#mRNA')
saveas(gcf,strcat(['GenePairedDFR/GenePairedDFR_Run', num2str(run)]),'jpg');
close(gcf);

figure
histogram(mh1v)
saveas(gcf,strcat('GenePairedDFR/GenePairedDFR_Histogram', num2str(run)),'jpg');
close(gcf)
...
writetable(Stats, strcat('GenePairedDFR/GenePairedDFR_PearsonSpearman.xlsx'),'WriteVariableNames', true);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
