...
writetable(DataTable, strcat('GenePairedDFRv2/GenePairedDFRv2_Run', num2str(run),'.xlsx'),'WriteVariableNames', true);
...
xlabel('Time')
ylabel('#mRNA')
saveas(gcf,strcat(['GenePairedDFRv2/GenePairedDFRv2_Run', num2str(run)]),'jpg');
close(gcf);

figure
histogram(mh1v)
saveas(gcf,strcat('GenePairedDFRv2/GenePairedDFRv2_Histogram', num2str(run)),'jpg');
close(gcf)
...
writetable(Stats, strcat('GenePairedDFRv2/GenePairedDFRv2_PearsonSpearman.xlsx'),'WriteVariableNames', true);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
